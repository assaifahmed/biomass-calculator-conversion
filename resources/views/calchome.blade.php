...
<div style="background-color: whitesmoke">
    <div class="bs-docs-section">
        ...
        <div class="form-group">
            ...
            {{-- <form name="inputdata" action="/calcresult2" method="POST" required> --}}
                {{ csrf_field() }}
                <fieldset>
                        ...
                        <tr>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="text" name="namakayu" class="form-control" placeholder="" readonly="">
                                </div>
                            </td>
                            <td></td>
                            <td>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="kadarair" step=".01" class="form-control" placeholder="" readonly="">
                                </div>
                            </td>
                            <td></td>
                            <td>
                                <div class="form-group">
                                    <label>Jenis Data Input</label>
                                    <input type="number" name="nilaidatainput" class="form-control" placeholder="" readonly="">
                                </div>
                            </td>
                        </tr>
                    </tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="beratjenispohon" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="nilaikaloripohon" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="berat-kayubasah" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="berat-kayukering" class="form-control" placeholder=""  readonly>
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="kayubulat-solid" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="woodchip-bulk" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="kayubakar-stack" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tr>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="ncv-gigajoule" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            <label>MWh</label>
                            <input type="number" name="ncv-kwh" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                </tr>
            </tbody>
                ...
                <tr class="">
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="heatingoil-liter" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="woodpellets-ton" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="lpg-liter" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                </tr>
            </tbody>
