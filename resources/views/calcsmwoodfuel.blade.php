                ...
                <tr class="">
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="staplemeter-sm" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                    <td></td>
                    <td>
                    ...
                    <td>
                        <div class="form-group">
                            ...
                            <input type="number" name="berat-staplemeter" class="form-control" placeholder="" readonly>
                        </div>
                    </td>
                </tr>
            </tbody>
